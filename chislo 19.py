...
for i in range(222, 1286):  # while (ik < 1): # количество файлов
    ...
    while (steps < len(viborka)):
        ...
        steps = steps + 1
        if key1 ==37:
            podchet_37 = podchet_37+1
        if  key1 == 29:
            list_raznica_shagov_19.append(raznica_shagov_19)
            raznica_shagov_19 = 1
            shagi = shagi+1
            all_19 = all_19+1
        else:
            raznica_shagov_19 = raznica_shagov_19+1
            shagi = shagi + 1
...
# prav_list.reverse()
print('37',podchet_37)
list_raznica_shagov_19.sort()
print('list_raznica_shagov_19', list_raznica_shagov_19)
slovar = get_counts(list_raznica_shagov_19)
i=0
podchet_vig_shagov = 0
for i in range(1,10):
    podchet_vig_shagov =podchet_vig_shagov + slovar[i]
print('slovar:', slovar)
print('all_19:', all_19)
print('all shagi',shagi -podchet_37)
print('srednee 19: ',(shagi -podchet_37)/all_19)
print('vig_shagi', podchet_vig_shagov )
print('podchet vuigr shagov *36',podchet_vig_shagov *36 )
print('vse shagi*36:',all_19 *36)
